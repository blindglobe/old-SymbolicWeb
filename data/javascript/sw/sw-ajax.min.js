...
swComet=function(){function b(){if(sw_comet_response){sw_comet_response=false;swComet("&do=ack")}else setTimeout("swComet('');",500)}function c(a){$.ajax({type:"GET",url:[swURL(),"?_sw_request-type=comet&_sw_viewport-id=",sw_viewport_id,a].join(""),dataType:"script",cache:false,complete:b})}return $.browser.mozilla?function(a){setTimeout(function(){c(a)},0)}:c}();function swHandleEvent(b,c,a,d){c()&&swAjax("&_sw_event=dom-event&_sw_callback-id="+b,a,d())}
